...
// class ProductFrontalCards extends StatefulWidget {
//   final Function(Map<String, String>)
//       onAddToCart; // Add the onAddToCart callback

//   const ProductFrontalCards({super.key, required this.onAddToCart});

//   @override
//   State<ProductFrontalCards> createState() => _ProductFrontalCardsState();
// }

// class _ProductFrontalCardsState extends State<ProductFrontalCards> {
...
//                       prices: productsfrontalItems[i]["prices"]
//                           as Map<String, String>,
//                       onAddToCart:
//                           widget.onAddToCart, // Pass the onAddToCart callback
//                     ),
//                 ],
//               ),
//             ),
...
class _ProductFrontalCardsState extends State<ProductFrontalCards> {
  ...
  // Helper function to fetch Supabase image URL
// Update the _getSupabaseImageUrl function to include proper error handling.
